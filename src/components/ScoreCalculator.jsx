  ...
  render() {
    return (
      <div>
        {" "}
        <div>
          <h2>This tool convert Iranian score into German's score system</h2>
        </div>
        <TextField
          id="standard-basic"
        ...
        >
          Your score in German's system is :{" "}
          {3 * [(20 - this.state.Score) / (20 - 10)] + 1}
        </div>
        <br></br>
        <Divider />
        <div style={{ fontSize: 20 }}>
          ...
          <div style={{ fontSize: 15 }}>
            ...
            <div>
              {" "}
              Z: The lowest Score that can be achieved in order to pass
            </div>
          </div>
        </div>
      </div>
