...
class Createdata extends Component {
  ...
  onSubmit_Create = async (field) => {
    const {Uni_name,Field_name ,Admission,LanguageScore,Overall_score} = this.state;
    ...
    if(Uni_name!=='',Field_name!=='',Admission!=='',LanguageScore!=='',Overall_score!==''){
   const result=await this.props.createpost_graphql(Uni_name,Field_name,Admission,LanguageScore,Overall_score);
      ...
      <form noValidate autoComplete="off">
        <div>
          ...
          <TextField
            id="standard-basic"
            label="Uni name"
            onChange={(b) => this.setState({ Uni_name: b.target.value })}
          />
        </div>
        <div>
          {" "}
          <TextField
            id="standard-basic"
            label="Field name "
            onChange={(b) => this.setState({ Field_name: b.target.value })}
          />
        </div>
        <div>
          {" "}
          <TextField
            id="standard-basic"
            label="Admission "
            onChange={(b) => this.setState({ Admission: b.target.value })}
          />
        </div>
        <div>
          {" "}
          <TextField
            id="standard-basic"
            label="LanguageScore "
            onChange={(b) => this.setState({ LanguageScore: b.target.value })}
          />
        </div>
        <div>
          {" "}
          <TextField
            id="standard-basic"
            label="Overall_score "
            onChange={(b) => this.setState({ Overall_score: b.target.value })}
          />
        </div>
        <div>
          {" "}
