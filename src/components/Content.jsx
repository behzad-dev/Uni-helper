...
const StyledTableRow = withStyles((theme) => ({
  root: {
    ...
    return (
              ...
              <TableHead>
                ...
                <StyledTableRow>
                  <StyledTableCell onClick={() =>
                            this.mysort("Uni_name")
                          } >University</StyledTableCell>
                  <StyledTableCell   onClick={() =>
                            this.mysort("Field_name")
                          } align="center">Major</StyledTableCell>
                  <StyledTableCell  onClick={() =>
                            this.mysort("Admission")
                          } align="center">Language</StyledTableCell>
                  <StyledTableCell  onClick={() =>
                            this.mysort("LanguageScore")
                          } align="center">Final score</StyledTableCell>
                  <StyledTableCell  onClick={() =>
                            this.mysort("Overall_score")
                          } align="center">Admission</StyledTableCell>
                </StyledTableRow>
              </TableHead>
              <TableBody>
                ...
                {/* {this.props.myitems &&this.props.myitems[0] &&
                  ...
                  {sorted && sorted[0] && sorted.map((row)=>(
                    <TableRow key={row._id}>
                      ...
                      <TableCell onClick={()=> window.open("http://google.com", "_blank")} align="center">{row.Field_name}</TableCell>
                 
                      <StyledTableCellBody align="center">{row.LanguageScore}</StyledTableCellBody>
                      <StyledTableCellBody align="center">{row.Overall_score}</StyledTableCellBody>
      ...
      >
{row.Admission}      </AccordionSummary>
      <AccordionDetails>
      a very good uni,,,oh its a very good uni,,,oh its a very good u
      a very good uni,,,oh its a very good uni,,,oh its a very good u
      oh its a very good uni,,,oh its a very good uni,,,oh its a very good uni,,,oh its a very good uni,,,oh its a very good uni,,,
      </AccordionDetails>
    </Accordion></StyledTableCellBody2>
                    </TableRow>
                  ))}
              </TableBody>
            </Table>
